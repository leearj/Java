...
*
*    purpose: This class is used to help create noise in the SimplexNoise class
*    
*******************************************************************************/ 
...
public class SimplexNoise_octave {  // Simplex noise in 2D, 3D and 4D
  ...
  // method: SimplexNoise_octave
  // purpose: constructor used to initialize p
  ...
  // method: fastfloor
  // purpose: This method is a *lot* faster than using (int)Math.floor(x)
  ...
  // method: dot
  // purpose: dot for x and y
  private static double dot(Grad g, double x, double y) {
    return g.x*x + g.y*y; }

  // method: dot
  // purpose: dot for x, y, z
  private static double dot(Grad g, double x, double y, double z) {
    return g.x*x + g.y*y + g.z*z; }

  // method: dot
  // purpose: dot for x, y, z, w
  private static double dot(Grad g, double x, double y, double z, double w) {
    return g.x*x + g.y*y + g.z*z + g.w*w; }


  // method: noise
  // purpose: 2D simplex noise
  ...
  // method: noise
  // purpose: 4D simplex noise, better simplex rank ordering method 2012-03-09
  ...
  // method: Grad
  // purpose: Inner class to speed upp gradient computations
